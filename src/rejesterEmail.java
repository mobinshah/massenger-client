...
public class rejesterEmail implements Initializable {
    ...
    private String from = "apmassenger@gmail.com";
    private String username = "apmassenger@gmail.com";
    private String password = "azsxdcfv12345678";
...
//        Construct a MimeMessage instance, populate the message headers and content and then send the message.
    ...
    public void initialize(URL location, ResourceBundle resources) {
        String c = createCode();
        sendMail(SingUp.Email, "your code", c);
